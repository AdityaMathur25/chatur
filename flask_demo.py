...
user_query = {"greeting": ["hi", "hello","hey","hlw","Yo wassup", "hey boss","hi senior","how can i server"],
              "bit" : ["tell me something about bit", "what is bit", "bit"],
              'branches':["tell me about branches in bit", "engineering branches in bit"]
}


bot_reply = {"greeting":["hi", "hello","hey","hlw","Yo wassup", "hey boss","hi senior","how can i serve you"],
